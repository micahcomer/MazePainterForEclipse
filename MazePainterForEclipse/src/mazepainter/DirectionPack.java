...
public class DirectionPack implements Externalizable{
    ...
    public void readExternal(ObjectInput in) throws IOException, ClassNotFoundException {
       ...
       if (hasItems)
       {
           ArrayList<mazeelements.maze.gamepieces.Item> iList = (ArrayList<mazeelements.maze.gamepieces.Item>)in.readObject();
       ...
       if (hasEnemies)
       {
           ArrayList<mazeelements.maze.gamepieces.Enemy> eList = (ArrayList<mazeelements.maze.gamepieces.Enemy>)in.readObject();
